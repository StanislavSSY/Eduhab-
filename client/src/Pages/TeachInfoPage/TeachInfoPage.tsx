    ...
    <div className={styled.container}>
      <div className={styled.headercontent}>
        <div className={styled.leftcont}>
          <div className={styled.title}>Galera</div>
        </div>
        <div className={styled.centercont}>
          <a className={styled.atag} href="#aboutproject">О Проекте</a>
          <a className={styled.atag} href="#typecourse">Виды курсов</a>
          <a className={styled.atag} href="#prices">Стоимость</a>
          <a className={styled.atag} href="#help">Поддержка</a>
        </div>
      ...
      <div className={styled.bodycontent}>
        <div className={styled.aboutservice}>
          <div className={styled.servicetitle}>Создайте собственный курс с помощью конструктора Galera</div>
          <div className={styled.serviceaftertitle}>Делитесь знаниями на крупнейшей образовательной платформе в России и СНГ, создавая бесплатные курсы или монетизируя свои знания с помощью платных</div>
          <div className={styled.fakebtn}>
            <Link className={styled.reftocoursecreatetwo} to={'/'}>Создать курс</Link>
          </div>
          <div>wait img</div>
        </div>
        <div className={styled.aboutGalera} id="aboutproject">
          <div className={styled.galeratitle}>
            Что такое Galera?
          </div>
          <div className={styled.titleresponse}>Многофункциональная и гибкая платформа для создания и размещения образовательных материалов</div>
          <div className={styled.preminfo}>
            <div className={styled.contpremleft}>
              <div className={styled.premlefttitle}>Монетизация</div>
              <div className={styled.premleftrespo}>Зарабатывайте делясь знаниями с другими</div>
            </div>
            <div className={styled.contpremcenter}>
              <div className={styled.premcentertitle}>Большая аудитория</div>
              <div className={styled.premcenterrespo}>7 000 000 пользователей используют Galera для обучения и создания курсов</div>
            </div>
            <div className={styled.contpremright}>
              <div className={styled.premrighttitle}>10 лет в сфере образования</div>
              <div className={styled.premrightrespo}>Разработали лучший конструктор курсов, который используют тысячи авторов</div>
            </div>
          </div>
        </div>
        ...
        <div className={styled.abouttypeofcourse} id="typecourse">
          ...
          <div className={styled.typecontainer}>
            <div className={styled.paidtype}>
              <div className={styled.typetitle}>Создавайте платные курсы для монетизации знаний</div>
              <div className={styled.typecontent}>Любой автор может разместить курс на продажу в рублях или долларах. Мы берём небольшую комиссию, принимаем и обрабатываем платежи. Вам будут доступны все функции создания курсов. Ваш курс будет доступен десяткам тысяч пользователей Galera.</div>
            </div>
            <div className={styled.freetype}>
              <div className={styled.typetitle}>Создавайте бесплатные онлайн-курсы</div>
              <div className={styled.typecontent}>Обучайте тому, в чем отлично разбираетесь. В каталоге собраны курсы по темам от биоинформатики до японского языка. Добавьте бесплатный курс по своей теме для тысяч человек аудитории Galera. Для бесплатного курса доступны базовые функции платформы.</div>
            </div>
          </div>
        </div>
          ...
          <div className={styled.containerprices}>
            <div className={styled.pricepaid}>
              ...
              <div className={styled.pricepaidbody}>
                ...
                <div className={styled.anytext}>Создавайте платные курсы и монетизируйте свои знания</div>
                <div className={styled.pricefakebtncontainer}>
                  <Link className={styled.reftomoreinfopaidcourse} to={'/'}>Узнать больше</Link>
                </div>
              </div>
            </div>
            <div className={styled.pricefree}>
              <div className={styled.pricepaidheader}>
                ...
                <div className={styled.functionalfree}>Ограниченная функциональность</div>
              </div>
              <div className={styled.borderbodyfree} />
              <div className={styled.pricefreebody}>
              <div className={styled.commissionfree}>Бесплатно</div>
              <div className={styled.anytextfree}>Создавайте открытые курсы без коммерческих целей</div>
              <div className={styled.pricefakebtncontainerfree}>
                <Link className={styled.reftomoreinfopaidcoursefree} to={'/'}>Создать открытый курс</Link>
              </div>
              </div>
            </div>
          </div>
        ...
        <div className={styled.help} id="help">
          ...
          <div className={styled.containerhelping}>
            ...
            <div className={styled.containerbody}>Задайте любые вопросы специалистам службы поддержки, чтобы получить помощь в создании онлайн-курса.</div>
            <div className={styled.containerfakebtnhelp}>
              <Link className={styled.reftohelp} to={'/'}>Обратиться</Link>
            </div>
          </div>
        </div>
      </div>
