    ...
    <>
      ...
      <div className={styles["catalog-block"]}>
        <div className={styles["catalog-block__content"]}>
          <div
            id="ember702"
            className="catalog-block-simple-course-lists ember-view"
          >
            <div className={styles["course-list-cards"]} data-list-type="grid">
              ...
              <div className={styles["course-list-card"]}>
                <a
                  className={styles["course-list-card__link-wrapper"]}
                  href="/"
                >
                  <div className={styles["course-list-card__title"]}>
                    Разработка на Python
                  </div>
                  <div className={styles["course-list-card__courses"]}>
                    49 курсов
                  </div>
                </a>
              </div>
